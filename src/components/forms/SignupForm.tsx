  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className='w-full sm:w-2/3 md:w-1/3 h-2/3 flex flex-col justify-between items-center gap-4 p-4 bg-gradient-to-b from-[#00000030] to-[#000000A0] rounded-xl'>
      ...
      <div className='w-full flex flex-col items-center gap-2'>
        <button type='submit' className='w-full py-2 px-4 text-light border-[2px] border-secondary hover:bg-secondary transition-colors rounded-lg'>Sign Up</button>
        <Link to='/login' className='w-fit text-center text-secondary hover:text-yellowAcent'>Already go an account?</Link>
      </div>
    </form>
  )
}
