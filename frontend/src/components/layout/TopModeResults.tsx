        ...
        <>
          <div className='w-full flex flex-grow justify-between items-center gap-4 py-4 px-8 bg-dark rounded-lg'>
            <div className='flex basis-16 flex-col items-center gap-2'>
              ...
              <span className='text-light text-nowrap opacity-80 text-2xl font-semibold'>{ topModeResult?.time15?.acc ? topModeResult?.time15?.acc + ' %' : '-' }</span>
            </div>
            <div className='flex basis-16 flex-col items-center gap-2'>
              ...
              <span className='text-light text-nowrap opacity-80 text-2xl font-semibold'>{ topModeResult?.time30?.acc ? topModeResult?.time30?.acc + ' %' : '-' }</span>
            </div>
            <div className='flex basis-16 flex-col items-center gap-2'>
              ...
              <span className='text-light text-nowrap opacity-80 text-2xl font-semibold'>{ topModeResult?.time60?.acc ? topModeResult?.time60?.acc + ' %' : '-' }</span>
            </div>
          </div>
          <div className='w-full flex flex-grow justify-between items-center gap-4 py-4 px-8 bg-dark rounded-lg'>
            <div className='flex basis-16 flex-col items-center gap-2'>
              ...
              <span className='text-light text-nowrap opacity-80 text-2xl font-semibold'>{ topModeResult?.words10?.acc ? topModeResult?.words10?.acc + ' %' : '-' }</span>
            </div>
            <div className='flex basis-16 flex-col items-center gap-2'>
              ...
              <span className='text-light text-nowrap opacity-80 text-2xl font-semibold'>{ topModeResult?.words15?.acc ? topModeResult?.words15?.acc + ' %' : '-' }</span>
            </div>
            <div className='flex basis-16 flex-col items-center gap-2'>
              ...
              <span className='text-light text-nowrap opacity-80 text-2xl font-semibold'>{ topModeResult?.words20?.acc ? topModeResult?.words20?.acc + ' %' : '-' }</span>
            </div>
          </div>
        </>
      )}
